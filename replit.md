...
- **Customer portal primary**: Sky blue `#40C0F2` / darker `#2AA8DC` (header gradients, icons, tab tints)
- **Customer portal background**: `#F5F6FA` (light grey)
...
## Brand Design
- **Customer palette**: Sky blue `#40C0F2`, Background `#F5F6FA`, Cherry `#D20001`
