...
const styles = StyleSheet.create({
  ...
  ticketDetailActions: { flexDirection: 'row', gap: 8, paddingHorizontal: 12, paddingVertical: 8, backgroundColor: WHITE, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: BORDER },
  ticketDetailAction: { flex: 1, minWidth: 0, flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: '#F8FAFC', borderWidth: 1, borderColor: BORDER, borderRadius: 8, paddingHorizontal: 8, paddingVertical: 7 },
  ticketDetailActionActive: { backgroundColor: '#EFF6FF', borderColor: '#BFDBFE' },
  ticketDetailActionText: { flex: 1, fontSize: 12, color: MID, fontWeight: '600' },
  ticketDetailClearAction: { width: 32, alignItems: 'center', justifyContent: 'center', backgroundColor: '#FFF1F2', borderWidth: 1, borderColor: '#FECDD3', borderRadius: 8 },
  customerDetailsSection: { backgroundColor: WHITE, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: BORDER, paddingHorizontal: 12, paddingTop: 10, paddingBottom: 8 },
  customerDetailsHeading: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 },
  customerDetailsTitle: { fontSize: 13, color: DARK, fontWeight: '700' },
  customerDetailsClear: { fontSize: 12, color: CHERRY, fontWeight: '700' },
  customerDetailsInput: { borderWidth: 1, borderColor: BORDER, borderRadius: 8, backgroundColor: '#F8FAFC', paddingHorizontal: 10, paddingVertical: 8, fontSize: 14, color: DARK, marginBottom: 7 },
  customerInviteRow: { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: '#F8FAFC', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 8, marginBottom: 2 },
  customerInviteTitle: { fontSize: 12, color: DARK, fontWeight: '700' },
  customerInviteSub: { fontSize: 11, color: MUTED, marginTop: 2, lineHeight: 14 },
