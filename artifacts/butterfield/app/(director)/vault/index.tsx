...
const s = StyleSheet.create({
  ...
  viewToggle: { flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: BORD },
  viewTab: { flex: 1, paddingVertical: 10, alignItems: 'center' },
  viewTabActive: { borderBottomWidth: 2, borderBottomColor: GOLD },
  viewTabText: { fontSize: 14, fontWeight: '500', color: MUTED },
  viewTabTextActive: { color: GOLD, fontWeight: '700' },

  statsStrip: { flexDirection: 'row', backgroundColor: SURFACE, borderBottomWidth: 1, borderBottomColor: BORD },
  ...
  searchRow: { flexDirection: 'row', alignItems: 'center', margin: 12, backgroundColor: SURFACE, borderRadius: 12, borderWidth: 1, borderColor: BORD },
  searchInput: { flex: 1, paddingVertical: 10, paddingHorizontal: 8, color: TEXT, fontSize: 14 },

  catScroll: { paddingHorizontal: 12, gap: 8, paddingBottom: 8 },
  catChip: { paddingHorizontal: 14, paddingVertical: 6, borderRadius: 20, backgroundColor: SURFACE, borderWidth: 1, borderColor: BORD },
  catChipText: { fontSize: 13, color: TEXTD, fontWeight: '500' },

  recipeCard: { flexDirection: 'row', backgroundColor: SURFACE, borderRadius: 14, borderWidth: 1, borderColor: BORD, overflow: 'hidden' },
  catBar: { width: 4 },
  recipeName: { flex: 1, fontSize: 15, fontWeight: '700', color: TEXT, marginRight: 8 },
  recipeMetaText: { fontSize: 12, color: MUTED },
  badge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 20, borderWidth: 1 },
  badgeText: { fontSize: 10, fontWeight: '700', letterSpacing: 0.4 },
  emptyAddBtn: { paddingHorizontal: 20, paddingVertical: 10, borderRadius: 12, borderWidth: 1, borderColor: GOLD + '66', backgroundColor: GOLD_BG },

  settingsCard: { backgroundColor: SURFACE, borderRadius: 16, padding: 18, borderWidth: 1, borderColor: BORD },
  settingsTitle: { fontSize: 16, fontWeight: '700', color: TEXT, marginBottom: 6 },
  catManageRow: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: BORD },
  catDot: { width: 10, height: 10, borderRadius: 5 },
  catManageName: { flex: 1, fontSize: 14, color: TEXT },
  catDeleteBtn: { padding: 6, backgroundColor: ERROR + '10', borderRadius: 8 },

  addCatRow: { flexDirection: 'row', gap: 10, marginTop: 14, alignItems: 'center' },
  addCatInput: { flex: 1, backgroundColor: BG, borderRadius: 10, paddingHorizontal: 12, paddingVertical: 10, color: TEXT, fontSize: 14, borderWidth: 1, borderColor: BORD },
  addCatBtn: { backgroundColor: GOLD, borderRadius: 10, padding: 10 },

  lockNowBtn: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingVertical: 12, paddingHorizontal: 16, borderRadius: 12, borderWidth: 1, borderColor: ERROR + '44', backgroundColor: ERROR + '08' },
});
