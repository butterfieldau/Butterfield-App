  ...
  // ── SYSTEM ─────────────────────────────────────────────────────────────────
  {
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          { icon: 'shield', label: 'Security Log', sub: 'Audit events, login attempts, POS actions & director changes', color: BLUE, directorOnly: true, onPress: () => router.push('/director-security-log' as any) },
        ],
      },
      {
        label: 'Integrations',
