...
const s = StyleSheet.create({
  ...
  managerBadgeText:{ fontSize: 10, fontWeight: '700', letterSpacing: 0.8 },
  ...
  clockLabel:      { fontSize: 11, fontWeight: '600', letterSpacing: 0.8 },
  ...
  clockSub:        { fontSize: 13, fontWeight: '400', lineHeight: 19 },
  ...
  sectionTitle:    { fontSize: 11, fontWeight: '600', letterSpacing: 1.5, marginTop: 4 },
  ...
  orderItems:      { fontSize: 12, fontWeight: '400', color: MUTED },
