...
function RootLayoutNav() {
  return (
    ...
    >
      ...
      <Stack.Screen name="director-crm" options={directorStandaloneScreenOptions} />
      <Stack.Screen name="director-customer-profiles" options={directorStandaloneScreenOptions} />
