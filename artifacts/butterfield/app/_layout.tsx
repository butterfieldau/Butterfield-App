...
function RootLayoutNav() {
  return (
    ...
    >
      ...
      <Stack.Screen name="customer-payment-methods" options={{ headerShown: false, animation: 'slide_from_right', gestureEnabled: true, fullScreenGestureEnabled: true, gestureDirection: 'horizontal' }} />
      ...
      <Stack.Screen name="table" options={{ headerShown: false, presentation: 'modal', animation: 'slide_from_bottom' }} />
