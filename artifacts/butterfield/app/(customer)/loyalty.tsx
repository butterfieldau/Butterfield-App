...
const styles = StyleSheet.create({
  ...
  infoCardSmall: { flex: 1, paddingBottom: 18, justifyContent: 'flex-start' },
  ...
  miniStampDot: { width: 13, height: 13, borderRadius: 6.5, borderWidth: 1.6, borderColor: 'rgba(255,255,255,0.72)' },
  infoButton: {
    marginTop: 16,
