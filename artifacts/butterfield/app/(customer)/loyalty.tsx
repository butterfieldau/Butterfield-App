...
const styles = StyleSheet.create({
  ...
  walletPrimaryButton: { flex: 1, borderRadius: 999, backgroundColor: '#0E1730', paddingVertical: 11, alignItems: 'center' },
  walletPrimaryButtonText: { color: WHITE, fontSize: 12, fontWeight: '700' },
  walletSecondaryButton: { flex: 1, borderRadius: 999, borderWidth: 1, borderColor: 'rgba(9,18,33,0.12)', paddingVertical: 11, alignItems: 'center' },
