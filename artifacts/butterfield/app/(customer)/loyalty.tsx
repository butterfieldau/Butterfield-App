...
const REWARD_PRESETS: Record<string, { icon: keyof typeof Feather.glyphMap; image?: any; tint: string; bg: [string, string] }> = {
  free_coffee: { icon: 'coffee', image: require('@/assets/images/coffee-tray-skip.png'), tint: '#5B7CFA', bg: ['#EEF4FF', '#DCE8FF'] },
  free_cookie: { icon: 'circle', image: require('@/assets/images/thank-you-cookie-character.png'), tint: '#C47B23', bg: ['#FFF3D8', '#FFE1B2'] },
  free_six_pack: { icon: 'package', image: require('@/assets/images/home-character.png'), tint: '#7A52E8', bg: ['#EEE8FF', '#DCD0FF'] },
  coffee_upgrade: { icon: 'trending-up', image: require('@/assets/images/coffee-tray-skip.png'), tint: '#0E9F6E', bg: ['#E9FFF6', '#C9F7E4'] },
  birthday_reward: { icon: 'gift', image: require('@/assets/images/thank-you-cookie-character.png'), tint: '#E866A8', bg: ['#FFF0F7', '#FFE0EF'] },
