...
const s = StyleSheet.create({
  ...
  signInAs:        { fontSize: 20, color: TEXT, fontFamily: 'Inter_700Bold', textTransform: 'uppercase', letterSpacing: 0.5 },
  ...
  submitBtn:       { height: 58, borderRadius: 29, alignItems: 'center', justifyContent: 'center', marginTop: 2 },
  submitBtnText:   { color: '#fff', fontSize: 17, letterSpacing: 0.3 },
