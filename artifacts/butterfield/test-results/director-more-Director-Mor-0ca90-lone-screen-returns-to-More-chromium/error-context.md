...
- Name: director-more.spec.ts >> Director More — standalone screen navigation >> back button on Pricing Tiers standalone screen returns to More
- Location: e2e/director-more.spec.ts:140:7
...
Call log:
  - waiting for locator('text=Pricing Tiers').first() to be visible
