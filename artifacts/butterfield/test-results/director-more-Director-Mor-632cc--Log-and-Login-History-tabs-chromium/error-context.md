...
- Name: director-more.spec.ts >> Director More — standalone screen navigation >> tapping Security Log from More opens screen with Audit Log and Login History tabs
- Location: e2e/director-more.spec.ts:120:7
...
Call log:
  - waiting for getByText('Security Log', { exact: true }).first() to be visible
