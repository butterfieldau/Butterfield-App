...
- Name: director-more.spec.ts >> Director More — standalone screen navigation >> back button on Settings standalone screen returns to More
- Location: e2e/director-more.spec.ts:152:7

# Error details

```
Error: director login failed: 429 — run POST /api/auth/seed-demo first
