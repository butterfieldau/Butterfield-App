...
export const CATEGORY_PALETTE: Record<string, CategoryPalette> = {
  ...
  matcha: {
    ...
    chipText: '#fff',
    emoji: '🍵',
    defaultTags: ['Japanese', 'Premium', 'Ceremonial', 'Antioxidant'],
  },
  tea: {
    bg: '#D4C4A8',
    banner: '#7A6040',
    ...
    chipText: '#fff',
    emoji: '🫖',
    defaultTags: ['Loose Leaf', 'Premium', 'Brewed', 'Hot'],
  },
  'cold-drinks': {
    bg: '#BDE0F4',
    banner: '#2A80BC',
    ...
    chipText: '#fff',
    emoji: '🧊',
    defaultTags: ['Iced', 'Refreshing', 'Cold', 'Chilled'],
  },
  'soft-serve': {
    bg: '#F8D8E8',
    banner: '#C06090',
    ...
    chipText: '#fff',
    emoji: '🍦',
    defaultTags: ['House-Made', 'Creamy', 'Seasonal', 'Fresh'],
  },
  specials: {
    bg: '#FFE5A0',
    banner: '#C08000',
    ...
    chipText: '#fff',
    emoji: '⭐',
    defaultTags: ['Daily', 'Limited', 'Special', 'Featured'],
  },
  seasonal: {
    bg: '#F4D0A8',
    banner: '#B06830',
    ...
    chipText: '#fff',
    emoji: '🍂',
    defaultTags: ['Seasonal', 'Limited', 'Local', 'Fresh'],
  },
  boxes: {
    bg: '#D4BAE8',
    banner: '#7A4AAA',
    ...
    chipText: '#fff',
    emoji: '🎁',
    defaultTags: ['Gift Box', 'Assorted', 'Premium', 'Ready'],
  },
  default: {
    bg: '#88C8E8',
    banner: '#5AA8D0',
